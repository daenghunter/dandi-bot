...
client.sendMessage(media);
 ...
 else if (msg.body.startsWith("!makefs ")) {
	 msg.reply("sebentarr.. kita proses dulu")
	  var h = msg.body.split("!makefs ")[1];
	 var nama = h.split("] ")[1];
...
Judul : ${judul1}
 ...
 _ Facebook Downloader By DandiBot _`
          );
...
Judul : ${judul1}
 ...
 _ Instagram Downloader By DandiBot _
...
YD.on("error", function(error) {
	...
	msg.reply('ketik !menu untuk melihat list menu bot | wa.me/6289636035164');
...
console.log(""+ h);
  ...
  _Primbon WhatsApp By DandiBot_
`
        );
});
  }
